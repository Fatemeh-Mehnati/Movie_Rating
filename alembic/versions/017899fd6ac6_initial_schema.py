...
Revision ID: 017899fd6ac6
Revises: 
Create Date: 2026-01-01 14:09:36.630205
...
def upgrade() -> None:
    ...
    sa.CheckConstraint('score >= 1 AND score <= 10', name='score_between_1_and_10'),
    sa.ForeignKeyConstraint(['movie_id'], ['movies.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
